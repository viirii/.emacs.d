(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (helm-projectile go-guru go-autocomplete pyvenv intero hindent haskell-mode neotree flymake-go go-mode helm undo-tree smooth-scrolling smooth-scroll magit-popup protobuf-mode dumb-jump wgrep expand-region ace-jump-mode ace-window flycheck-clojure clojure-mode-extra-font-locking clojure-snippets cider cider-decompile ein elpy py-autopep8 jedi nyan-mode helm-ebdb kubernetes auto-complete exec-path-from-shell yasnippet ggtags whitespace-cleanup-mode smart-mode-line dash zenburn-theme rainbow-mode rainbow-delimiters paredit fill-column-indicator company autopair ac-cider)))
